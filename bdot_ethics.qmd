...
model_brm <- brm(state ~ tag_type + (1 | season) + (1 | parent), 
                 data = nest_fates, 
...
# Create effect plot for 'tag_type' using ggpredict
predictions_tag_type <- ggpredict(model_brm, terms = "tag_type", type = "fixed")
